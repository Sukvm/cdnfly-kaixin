...
cd /opt/
download "https://raw.fastgit.org/zhj15265123/cdnfly-kaixin/main/cdnfly/$tar_gz_name" "https://raw.fastgit.org/zhj15265123/cdnfly-kaixin/main/cdnfly/$tar_gz_name" "$tar_gz_name"
...
if [ -f /opt/cdnfly/master/view/upgrade.so ]; then
	wget https://raw.fastgit.org/zhj15265123/cdnfly-kaixin/main/cdnfly/api.py -O /opt/venv/lib/python2.7/site-packages/requests/api.py
